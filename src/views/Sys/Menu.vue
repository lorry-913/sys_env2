<template>
  <div class="page-container">
    ...
    <!-- 添加修改界面 -->
    <el-dialog title="添加" width="40%" :visible.sync="addFlag" :close-on-click-modal="false">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button :size="size"  @click="addFlag = false">{{$t('action.cancel')}}</el-button>
    ...
    <el-dialog title="编辑" width="40%" :visible.sync="editFlag" :close-on-click-modal="false">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button :size="size"  @click="editFlag = false">{{$t('action.cancel')}}</el-button>
        <el-button :size="size"  type="primary" @click="submitEidtForm()">{{$t('action.comfirm')}}</el-button>
      </span>
    </el-dialog>
